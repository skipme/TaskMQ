...
%SystemRoot%\Microsoft.NET\Framework\v4.0.30319\csc.exe /reference:"System.dll" /reference:"System.Core.dll"^
 /reference:".\RazorEngine\RazorEngine.dll" create_BBQ_static_html.cs

)
if not exist "RazorEngine.dll" (
copy ".\RazorEngine\RazorEngine.dll" "RazorEngine.dll" 
)
if not exist "System.Web.Razor.dll" (
copy ".\RazorEngine\System.Web.Razor.dll" "System.Web.Razor.dll" 
)
