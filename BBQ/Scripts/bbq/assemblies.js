(function ($) {
    ...
    bbq_tmq.assemblies.CheckBS = function (bsname, bsparams, resp) {
        ...
        }, { CheckBS: true, BSName: bsname, BSParameters: bsparams }, bbq_tmq.url_assemblies);
